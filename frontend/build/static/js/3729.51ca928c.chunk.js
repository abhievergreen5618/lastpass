  ...
  [3729],
  {
    83729: (e, n, t) => {
      ...
      var r,
        ...
        _ = new Date(),
        k = function (e, n) {
          r || ((r = n), (i = e), (o = new Date()), B(removeEventListener), D())
        },
        D = function () {
          if (i >= 0 && i < o - _) {
            var e = {
              ...
              var t,
                ...
                u = function (e) {
                  e.startTime < o.firstHiddenTime &&
                    ((c.value = e.processingStart - e.startTime), c.entries.push(e), t(!0))
                },
                f = function (e) {
                  e.forEach(u)
                },
                d = p('first-input', f)
              ;(t = v(e, c, x, n.reportAllChanges)),
                d &&
                  h(
                    g(function () {
        ...
        j = function () {
          return c ? R : performance.interactionCount || 0
        },
        z = function () {
          'interactionCount' in performance ||
            c ||
            (c = p('event', q, { type: 'event', buffered: !0, durationThreshold: 0 }))
        },
        G = [200, 500],
        J = 0,
        K = function () {
            ...
            w(function () {
              ...
              var r,
                ...
                o = function (e) {
                  ...
                  var n,
                    t = ((n = Math.min(Q.length - 1, Math.floor(K() / 50))), Q[n])
                  t &&
                    t.latency !== i.value &&
              ...
              ;(r = v(e, i, G, n.reportAllChanges)),
                a &&
                  ...
                  h(function () {
                    o(a.takeRecords()),
                      i.value < 0 && K() > 0 && ((i.value = 0), (i.entries = [])),
                      r(!0)
                  }),
                  s(function () {
                    ;(Q = []), (J = j()), (i = l('INP')), (r = v(e, i, G, n.reportAllChanges))
                  }))
            })
        },
        X = [2500, 4e3],
          ...
          ;(n = n || {}),
            w(function () {
              ...
              if (a) {
                ...
                var c = g(function () {
                  Y[i.id] || (o(a.takeRecords()), a.disconnect(), (Y[i.id] = !0), t(!0))
                })
                ;['keydown', 'click'].forEach(function (e) {
                  ...
                  s(function (r) {
                    ;(i = l('LCP')),
                      (t = v(e, i, X, n.reportAllChanges)),
                      m(function () {
                        ;(i.value = performance.now() - r.timeStamp), (Y[i.id] = !0), t(!0)
                      })
                  })
              }
            })
...
//# sourceMappingURL=3729.51ca928c.chunk.js.map
