        ...
        (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsxs)(i.x, {
              ...
              children: [
                (0, r.jsxs)(l.b, {
                  children: [
                    'Headings',
                    (0, r.jsx)(n.cG, { href: 'https://coreui.io/docs/content/typography/' }),
                  ],
                }),
                (0, r.jsxs)(d.s, {
                  children: [
                      ...
                      children: [
                        (0, r.jsx)('thead', {
                          children: (0, r.jsxs)('tr', {
                            children: [
                              (0, r.jsx)('th', { children: 'Heading' }),
                              (0, r.jsx)('th', { children: 'Example' }),
                            ],
                          }),
                        }),
                        (0, r.jsxs)('tbody', {
            ...
            (0, r.jsxs)(i.x, {
              className: 'mb-4',
              children: [
                (0, r.jsx)(l.b, { children: 'Headings' }),
                (0, r.jsxs)(d.s, {
                  children: [
                    (0, r.jsxs)('p', {
                      children: [
                        (0, r.jsx)('code', { className: 'highlighter-rouge', children: '.h1' }),
                        ' through',
                        (0, r.jsx)('code', { className: 'highlighter-rouge', children: '.h6' }),
                    ...
                    (0, r.jsxs)('div', {
                      ...
                      children: [
                        (0, r.jsx)('p', { className: 'h1', children: 'h1. Bootstrap heading' }),
                        (0, r.jsx)('p', { className: 'h2', children: 'h2. Bootstrap heading' }),
                        (0, r.jsx)('p', { className: 'h3', children: 'h3. Bootstrap heading' }),
                        (0, r.jsx)('p', { className: 'h4', children: 'h4. Bootstrap heading' }),
                        (0, r.jsx)('p', { className: 'h5', children: 'h5. Bootstrap heading' }),
                        (0, r.jsx)('p', { className: 'h6', children: 'h6. Bootstrap heading' }),
                      ],
                    }),
                  ],
                }),
            ...
            (0, r.jsxs)(i.x, {
              className: 'mb-4',
              children: [
                (0, r.jsx)('div', { className: 'card-header', children: 'Display headings' }),
                (0, r.jsxs)('div', {
                  className: 'card-body',
                  children: [
                    (0, r.jsxs)('p', {
                      children: [
                        ...
                        (0, r.jsx)('strong', { children: 'display heading' }),
            ...
            (0, r.jsxs)(i.x, {
              className: 'mb-4',
              children: [
                (0, r.jsx)(l.b, { children: 'Inline text elements' }),
                (0, r.jsxs)(d.s, {
                  children: [
                    (0, r.jsxs)('p', {
                      children: [
                      ...
                      children: [
                        (0, r.jsxs)('p', {
                          children: [
                            ...
                            (0, r.jsx)('mark', { children: 'highlight' }),
                            ' text.',
                          ],
                        }),
                        (0, r.jsx)('p', {
            ...
            (0, r.jsxs)(i.x, {
              className: 'mb-4',
              children: [
                (0, r.jsx)(l.b, { children: 'Description list alignment' }),
                (0, r.jsxs)(d.s, {
                  children: [
                    (0, r.jsxs)('p', {
                      children: [
                    ...
                    (0, r.jsx)('div', {
                      ...
                      children: (0, r.jsxs)('dl', {
                        ...
                        children: [
                          ...
                          (0, r.jsx)('dt', { className: 'col-sm-3', children: 'Euismod' }),
                          (0, r.jsxs)('dd', {
                            className: 'col-sm-9',
                            children: [
                              (0, r.jsx)('p', {
                          ...
                          (0, r.jsx)('dt', { className: 'col-sm-3', children: 'Malesuada porta' }),
                          (0, r.jsx)('dd', {
                            className: 'col-sm-9',
                          ...
                          (0, r.jsx)('dt', { className: 'col-sm-3', children: 'Nesting' }),
                          (0, r.jsx)('dd', {
                            className: 'col-sm-9',
                            children: (0, r.jsxs)('dl', {
                              className: 'row',
      ...
      var i = a(50949),
        ...
        t = (0, l.forwardRef)(function (e, s) {
          var a,
            ...
            c = e.color,
            t = e.textColor,
            h = (0, i._T)(e, ['children', 'className', 'color', 'textColor'])
            ...
            (0, i.pi)(
              {
                className: (0, r.Z)(
                  'card',
                  ((a = {}), (a['bg-'.concat(c)] = c), (a['text-'.concat(t)] = t), a),
                  n,
                ),
              },
              h,
    ...
    45813: (e, s, a) => {
      ...
      var i = a(50949),
        ...
        c = (0, l.forwardRef)(function (e, s) {
          var a = e.children,
            d = e.className,
            n = (0, i._T)(e, ['children', 'className'])
          return l.createElement(
            'div',
            (0, i.pi)({ className: (0, r.Z)('card-body', d) }, n, { ref: s }),
            a,
          )
        })
      ;(c.propTypes = { children: n().node, className: n().string }), (c.displayName = 'CCardBody')
    },
    42177: (e, s, a) => {
      a.d(s, { b: () => c })
      var i = a(50949),
        ...
        c = (0, l.forwardRef)(function (e, s) {
          var a = e.children,
            ...
            n = void 0 === d ? 'div' : d,
            c = e.className,
            t = (0, i._T)(e, ['children', 'component', 'className'])
          return l.createElement(
            n,
            (0, i.pi)({ className: (0, r.Z)('card-header', c) }, t, { ref: s }),
            a,
          )
        })
      ;(c.propTypes = { children: n().node, className: n().string, component: n().elementType }),
        (c.displayName = 'CCardHeader')
    },
  },
])
//# sourceMappingURL=9331.d990f6b0.chunk.js.map
