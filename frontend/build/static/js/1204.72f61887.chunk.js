  ...
  [1204],
  {
      ...
      const p = () =>
        (0, d.jsxs)(n.r, {
          children: [
            (0, d.jsx)(s.b, {
              xs: 12,
              children: (0, d.jsxs)(t.x, {
                className: 'mb-4',
                children: [
                  (0, d.jsxs)(r.b, {
                    children: [
                      (0, d.jsx)('strong', { children: 'React Select' }),
                      ' ',
                      (0, d.jsx)('small', { children: 'Default' }),
                    ],
                  }),
                  (0, d.jsx)(i.s, {
                    children: (0, d.jsx)(c.q3, {
                      href: 'forms/select',
                      children: (0, d.jsxs)(o.L, {
                        'aria-label': 'Default select example',
                        children: [
                          (0, d.jsx)('option', { children: 'Open this select menu' }),
                          (0, d.jsx)('option', { value: '1', children: 'One' }),
                          (0, d.jsx)('option', { value: '2', children: 'Two' }),
                          (0, d.jsx)('option', { value: '3', children: 'Three' }),
                        ],
                      }),
                    }),
                  }),
                  ...
                  (0, d.jsxs)(i.s, {
                    children: [
                      ...
                      (0, d.jsxs)('p', {
                        ...
                        children: [
                          'The ',
                          (0, d.jsx)('code', { children: 'multiple' }),
                      ...
                      (0, d.jsxs)('p', {
                        ...
                        children: [
                          'As is the ',
                          (0, d.jsx)('code', { children: 'htmlSize' }),
                          ' property:',
                        ],
                      }),
                      (0, d.jsx)(c.q3, {
                ...
                children: [
                  (0, d.jsxs)(r.b, {
                    children: [
                      (0, d.jsx)('strong', { children: 'React Select' }),
                      ' ',
                      (0, d.jsx)('small', { children: 'Disabled' }),
                    ],
                  }),
                  (0, d.jsxs)(i.s, {
                    children: [
                      (0, d.jsxs)('p', {
                        ...
                        children: [
                          'Add the ',
                          (0, d.jsx)('code', { children: 'disabled' }),
    ...
    45813: (e, a, l) => {
      ...
      var n = l(50949),
        ...
        r = l.n(t),
        i = l(47577),
        o = (0, s.forwardRef)(function (e, a) {
          var l = e.children,
            t = e.className,
            r = (0, n._T)(e, ['children', 'className'])
          return s.createElement(
            'div',
            (0, n.pi)({ className: (0, i.Z)('card-body', t) }, r, { ref: a }),
            l,
          )
        })
      ;(o.propTypes = { children: r().node, className: r().string }), (o.displayName = 'CCardBody')
    },
    42177: (e, a, l) => {
      l.d(a, { b: () => o })
      var n = l(50949),
        ...
        o = (0, s.forwardRef)(function (e, a) {
          ...
          return s.createElement(
            r,
            (0, n.pi)({ className: (0, i.Z)('card-header', o) }, c, { ref: a }),
            l,
          )
        })
      ;(o.propTypes = { children: r().node, className: r().string, component: r().elementType }),
      ...
      var n = l(50949),
        ...
        o = function (e) {
          ...
          return s.createElement(
            ...
            t && s.createElement(i.C, { id: a, invalid: !0, tooltip: c }, t),
            r && s.createElement(i.C, { valid: !0, tooltip: c }, r),
          )
        }
      ;(o.propTypes = {
    ...
    25117: (e, a, l) => {
      ...
      var n = l(50949),
        ...
        p = (0, s.forwardRef)(function (e, a) {
          ...
          return s.createElement(
            i,
            (0, n.pi)({ className: (0, d.Z)('form-text', t) }, o, { ref: a }),
            l,
          )
        })
      ...
      var m = function (e) {
        ...
        return m
          ? s.createElement(
              ...
              { className: d },
              a,
              s.createElement(c.L, { htmlFor: f }, u || m),
              b && s.createElement(p, { id: l }, b),
              s.createElement(y, null),
            )
          : s.createElement(
              s.Fragment,
              null,
              u && s.createElement(c.L, { htmlFor: f }, u),
              a,
              b && s.createElement(p, { id: l }, b),
              s.createElement(y, null),
            )
            ...
            (0, n.pi)(
              {
                className: (0, i.Z)(
                  ((l = {}),
                  (l['invalid-'.concat(p ? 'tooltip' : 'feedback')] = d),
                  (l['valid-'.concat(p ? 'tooltip' : 'feedback')] = m),
                  l),
                  r,
                ),
              },
    ...
    41339: (e, a, l) => {
      ...
      var n = l(50949),
        ...
        o = (0, s.forwardRef)(function (e, a) {
          ...
          return s.createElement(
            'div',
            (0, n.pi)({ className: (0, i.Z)('form-floating', t) }, r, { ref: a }),
            l,
          )
        })
      ;(o.propTypes = { children: r().node, className: r().string }),
    ...
    35424: (e, a, l) => {
      ...
      var n = l(50949),
        ...
        o = (0, s.forwardRef)(function (e, a) {
          ...
          return s.createElement(
            'label',
            (0, n.pi)(
              { className: null !== r && void 0 !== r ? r : (0, i.Z)('form-label', t) },
              o,
              { ref: a },
            ),
            l,
      ...
      ;(o.propTypes = { children: r().node, className: r().string, customClassName: r().string }),
    ...
    26101: (e, a, l) => {
      ...
      ;(c.propTypes = (0, n.pi)(
        { className: r().string, htmlSize: r().number, options: r().array },
        o.e.propTypes,
      )),
      ...
      var n = l(50949),
        ...
        c = (0, s.forwardRef)(function (e, a) {
          ...
          return (
            ...
            s.createElement(
              'div',
              (0, n.pi)({ className: (0, i.Z)(c.length > 0 ? c : 'col', t) }, r, { ref: a }),
              l,
            )
          )
        }),
      ...
      var n = l(50949),
        ...
        c = (0, s.forwardRef)(function (e, a) {
          ...
          return (
            ...
            s.createElement('div', { className: (0, i.Z)('row', c, t), ref: a }, l)
          )
        }),
        d = r().shape({
...
//# sourceMappingURL=1204.72f61887.chunk.js.map
